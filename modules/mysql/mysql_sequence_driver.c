...
register int mysql_sequences[SIZE_SEQUENCES];
EXPORT_SYMBOL(mysql_sequences);
...
long  device_ioctl(struct file *file, unsigned int ioctl_num, unsigned long ioctl_param)
{
	...
	__put_user(mysql_sequences[ioctl_num], (int *)ioctl_param);
	asm( "mov %1, %%ebx;"
 	     "inc %%ebx;"
         "mov %%ebx, %0" : "=r"(mysql_sequences[ioctl_num]) : "r" (mysql_sequences[ioctl_num]));
